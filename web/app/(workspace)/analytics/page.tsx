...
export default function AnalyticsPage() {
  ...
  return (
    <PageContainer>
      ...
      {/* Directly under "Ask your pipeline": funnel · capture mix · score proof · automation health */}
      ...
      {/* Moved up under the funnel/score group: revenue leakage + risk & opportunity radar */}
      <div className="mt-3">
